...
<input id="update-card" name="update-card" placeholder="card number" type="text" maxlength="16" pattern="[0-9]{16}" size="60"  value="<?php echo $creditcard; ?>"  required/><br>
Security Code: <br>
<input id="update-security" name="update-security" placeholder="security code" type="text" maxlength="3" pattern="[0-9]{3}"  value="<?php echo $security; ?>"  size="60" required/><br>
Expiration Date: <br>
